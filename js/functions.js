 ...
 */
//let billP = prompt(`how much was the bill`);
//let tipP = prompt(`How much would you like to tip`);
//let total = calculateTip(billP,tipP);
//alert (`here is how much you should tip $${total}`);
/**
 * TODO:
